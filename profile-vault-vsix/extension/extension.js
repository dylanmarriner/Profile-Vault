...
async function activate(ctx) {
    ...
    const profileProvider = new treeProvider_1.ProfileProvider(store);
    vscode.window.registerTreeDataProvider("profileVault.profiles", profileProvider);
    ctx.subscriptions.push(vscode.commands.registerCommand("profileVault.refresh", () => profileProvider.refresh()), vscode.commands.registerCommand("profileVault.capture", async () => {
        try {
